...
- (void)initUIsize
{
    ...
    UIVisualEffectView* bottomView = [_backgroundView viewWithTag:2];
    if (!bottomView) {
        bottomView = [UIVisualEffectView new];
...
- (void)showItemAnimate
{
    ...
    [_dataSource enumerateObjectsUsingBlock:^(id _Nonnull obj, NSUInteger idx, BOOL* _Nonnull stop) {
        ...
        case HyPopMenuViewAnimationTypeCenter:
            toRect = [weakView getFrameAtIndex:idx];
            fromRect = CGRectMake(CGRectGetMidX(weakView.frame) - CGRectGetWidth(toRect ) / 2,
    ...
    [_dataSource enumerateObjectsUsingBlock:^(id _Nonnull obj, NSUInteger idx, BOOL* _Nonnull stop) {
        ...
        case HyPopMenuViewAnimationTypeCenter:
            ...
            toRect = CGRectMake(CGRectGetMidX(weakView.frame) - CGRectGetWidth(fromRect) / 2,
                (CGRectGetMinY(fromRect) + (kH - CGRectGetMinY(fromRect))) - 25,
                fromRect.size.width,
