...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    [UIView animateWithDuration:_isFormWebImage?0:SDPhotoBrowserHideImageAnimationDuration animations:^{
...
- (void)showFirstImage
{
    ...
    [UIView animateWithDuration:_isFormWebImage?0: SDPhotoBrowserShowImageAnimationDuration animations:^{
        tempView.center = self.center;
