...
#import "CXAuthInfo.h"
@interface CXBlogDetailModel : NSObject
...
@property (nonatomic,copy) NSString * location_latitude;
@property (nonatomic,copy) NSString *location_longitude;
@property (nonatomic,copy) NSString *location_desc;
